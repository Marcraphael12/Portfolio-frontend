...
const About = ()=> {
	return (
		<>
		<section id="About" className='flex flex-col justify-between'>
			<div className='text'>
			...
			<div className='bg-[#0400ff18] skills flex flex-col mt-4 border border-black'>
			...
			<div className='flex flex-col bg-[#0400ff18] skills mt-4 border border-black'>
				<h3 className='text-xl font-bold'>
					Languages skills
				</h3>
